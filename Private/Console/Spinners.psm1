...
class SpinnerKnown {
  static [Spinner]$Default = ""
  static [Spinner]$Ascii = "Ascii"
  static [Spinner]$Dots = "Dots"
  static [Spinner]$Dots2 = "Dots2"
  static [Spinner]$Dots3 = "Dots3"
  static [Spinner]$Dots4 = "Dots4"
  static [Spinner]$Dots5 = "Dots5"
  static [Spinner]$Dots6 = "Dots6"
  static [Spinner]$Dots7 = "Dots7"
  static [Spinner]$Dots8 = "Dots8"
  static [Spinner]$Dots9 = "Dots9"
  static [Spinner]$Dots10 = "Dots10"
  static [Spinner]$Dots11 = "Dots11"
  static [Spinner]$Dots12 = "Dots12"
  static [Spinner]$Dots13 = "Dots13"
  static [Spinner]$Dots14 = "Dots14"
  static [Spinner]$Dots8Bit = "Dots8Bit"
  static [Spinner]$DotsCircle = "DotsCircle"
  static [Spinner]$Sand = "Sand"
  static [Spinner]$Line = "Line"
  static [Spinner]$Line2 = "Line2"
  static [Spinner]$Pipe = "Pipe"
  static [Spinner]$SimpleDots = "SimpleDots"
  static [Spinner]$SimpleDotsScrolling = "SimpleDotsScrolling"
  static [Spinner]$Star = "Star"
  static [Spinner]$Star2 = "Star2"
  static [Spinner]$Flip = "Flip"
  static [Spinner]$Hamburger = "Hamburger"
  static [Spinner]$GrowVertical = "GrowVertical"
  static [Spinner]$GrowHorizontal
  static [Spinner]$Balloon
  static [Spinner]$Balloon2
  static [Spinner]$Noise
  ...
  static [Spinner]$SoccerHeader
  static [Spinner]$Mindblown
  static [Spinner]$Speaker = "Speaker"
  static [Spinner]$OrangePulse = "OrangePulse"
  static [Spinner]$BluePulse = "BluePulse"
  static [Spinner]$OrangeBluePulse = "OrangeBluePulse"
  static [Spinner]$TimeTravel = "TimeTravel"
  static [Spinner]$Aesthetic = "Aesthetic"
  static [Spinner]$DwarfFortress = "DwarfFortress"
}
